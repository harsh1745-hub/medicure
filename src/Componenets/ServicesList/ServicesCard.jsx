  ...
  return (
    <div className='py-[30px] px-3 lg:px-5'>
        ...
        <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'> {desc}</p>
           ...
           <Link to='/doctor' className='w-[44px] h-[44px] rounded-full border border-solid border-black  items-centre justify-center group hover:bg-primaryColor hover:border-none'>
